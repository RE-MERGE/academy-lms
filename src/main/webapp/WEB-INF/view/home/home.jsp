...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .brand-logo span { color: var(--bright); }
        ...
        .card {
            ...
            box-shadow: 0 32px 80px rgba(0,0,0,.5), 0 0 0 1px rgba(77,143,255,.08) inset;
            opacity: 0;
        ...
        .btn-register { background: var(--yellow); color: #1a1200; }
        .btn-find     { background: var(--red);    color: var(--white); }
...
<div class="page">
    ...
    <div class="form-panel">
        <div class="card">
            ...
            <form:form id="loginForm" action="${pageContext.request.contextPath}/user/login"
                ...
                <div class="btn-row">
                    <button type="button" class="btn btn-register"
                            onclick="location.href='${pageContext.request.contextPath}/user/joinForm'">회원가입</button>
                    <button type="button" class="btn btn-find"
                            onclick="location.href='${pageContext.request.contextPath}/home/findAccount'">아이디 / 비밀번호 찾기</button>
                </div>
