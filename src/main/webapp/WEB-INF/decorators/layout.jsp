...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=DM+Serif+Display&family=Noto+Sans+KR:wght@400;500;600;700&display=swap"
          rel="stylesheet">
    ...
    <div class="layout-body">
        ...
        <nav class="sidebar">
            ...
            <a href="${pageContext.request.contextPath}/home/dashboard" class="sidebar-item">
                <img src="${pageContext.request.contextPath}/img/icon_dashboard.png" alt="대시보드 아이콘" width="50px"
                     height="50px">
            ...
            <a href="${pageContext.request.contextPath}/course/home" class="sidebar-item" id="course-menu">
                <img src="${pageContext.request.contextPath}/img/icon_courses.png" alt="전체과목 아이콘" width="50px"
                     height="50px">
                <span class="si-label">전체 과목</span>
            </a>

            <a href="${pageContext.request.contextPath}/enrollment/courseEnrollment" class="sidebar-item">
                <img src="${pageContext.request.contextPath}/img/icon_enrollment.png" alt="수강신청 아이콘" width="50px"
                     height="50px">
                <span class="si-label">수강신청</span>
            </a>

            <a href="${pageContext.request.contextPath}/board/list" class="sidebar-item">
                <img src="${pageContext.request.contextPath}/img/icon_board.png" alt="게시판 아이콘" width="50px"
                     height="50px">
            ...
            <a href="${pageContext.request.contextPath}/user/myPage" class="sidebar-item">
                <img src="${pageContext.request.contextPath}/img/icon_mypage.png" alt="마이페이지 아이콘" width="50px"
                     height="50px">
            ...
            <c:if test="${sessionScope.sessionUser.role == 'ADMIN'}">
                ...
                <a href="${pageContext.request.contextPath}/admin/userList" class="sidebar-item">
                    <img src="${pageContext.request.contextPath}/img/icon_Member Management.png" alt="회원관리 아이콘"
                         width="50px" height="50px">
                    <span class="si-label">전체 회원 관리</span>
                </a>

                <a href="${pageContext.request.contextPath}/admin/adminCourseList" class="sidebar-item">
                    <img src="${pageContext.request.contextPath}/img/icon_Course Management.png" alt="수업관리 아이콘"
                         width="50px" height="50px">
                    <span class="si-label">전체 수업 관리</span>
                </a>

                <a href="${pageContext.request.contextPath}/admin/roomTimetable" class="sidebar-item">
                    <img src="${pageContext.request.contextPath}/img/icon_timetable.png" alt="수업관리 아이콘" width="43px"
                         height="43px">
                    ...
                    <c:forEach var="course" items="${courseList}">
                        <li class="flyout-item">
                            ...
                            <button class="fav-btn ${isFav ? 'active' : ''}"
                                    onclick="toggleFavorite(event, this, ${course.course_no})">
                                    ${isFav ? '★' : '☆'}
                            </button>
                        </li>
                    </c:forEach>
        ...
        <c:if test="${showSubjectSidebar}">
            ...
            <aside class="subject-sidebar">
                ...
                <nav class="subject-nav">
                    ...
                    <a href="${pageContext.request.contextPath}/board/subjectHome?courseNo=${course.course_no}" class="subject-nav-item active">
                    ...
                    <a href="${pageContext.request.contextPath}/course/profScore" class="subject-nav-item">
                    ...
                    <a href="${pageContext.request.contextPath}/board/list_qna?boardType=QNA&courseNo=${course.course_no}" class="subject-nav-item">
