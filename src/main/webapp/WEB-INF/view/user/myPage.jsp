    ...
    <head>
        ...
        <style>
            ...
            .grade-table th:nth-child(2), .grade-table td:nth-child(2) { width: 25%; text-align: center; }
            .grade-table th:nth-child(3), .grade-table td:nth-child(3) { width: 25%; text-align: center; }
            .grade-table th:nth-child(4), .grade-table td:nth-child(4) { width: 25%; text-align: center; }
                                ...
                                <tr>
                                    ...
                                    <c:when test="${sessionUser.role == 'PROFESSOR'}">
                                        ...
                                        <c:otherwise>
                                            <td>
                                                <c:choose>
                                                    <c:when test="${grade.examType eq 'MIDTERM'}">
                                                        <span class="type-badge badge-indigo">중간고사</span>
                                                    </c:when>
                                                    <c:when test="${grade.examType eq 'FINAL'}">
                                                        <span class="type-badge badge-purple">기말고사</span>
                                                    </c:when>
                                                    <c:when test="${grade.examType eq 'ATTENDANCE'}">
                                                        <span class="type-badge badge-purple">출석</span>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <span class="type-badge badge-gray">기타</span>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
                                            <td style="font-weight: 700;">${grade.score}</td>
                                            <td style="font-weight: 700;">${grade.alphabet}</td>
                                        </c:otherwise>
                                    </c:choose>
                                </tr>
                            </c:forEach>
