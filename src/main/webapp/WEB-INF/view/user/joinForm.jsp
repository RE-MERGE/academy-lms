...
<head>
    ...
    <style>
        ...
        /* 기존 CSS 클래스(input-style)를 확실하게 정의해주세요 */
        .input-style {
            width: 100%;
            padding: 10px;
        ...
        .profile-preview { width: 100%; height: 100%; border-radius: 50%; object-fit: cover; border: 3px solid var(--bright); background: rgba(255, 255, 255, 0.1); }
    ...
    <div class="page">
        <div class="form-panel">
            <div class="card">
                ...
                <%-- modelAttribute는 컨트롤러에서 보낸 객체 이름과 일치해야 합니다 --%>
                <form:form action="join" method="post" enctype="multipart/form-data" modelAttribute="userForm">
